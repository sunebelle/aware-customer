      ...
      <div className="flex flex-col">
        ...
        {items.length > 0 &&
          items.map((item, i) => (
            <div
              key={uuidv4()}
              className="flex flex-row py-3 px-3 space-x-6 border-b border-[#eaeaea] "
            >
              <img
                ...
                alt={item.name}
              />
              <div className="flex-grow content-between justify-between flex-col">
                <h2 className="Montserrat text-[#4d4d4d] capitalize font-semibold text-xs leading-5">
                  {item.name}
                </h2>
                {/* <h2 className="Montserrat text-[#4d4d4d] capitalize font-semibold text-xs leading-5">
                  {item.name}
                </h2> */}
                <div className="flex w-full flex-row  justify-between Montserrat-s font-normal">
                  <span className="text-[#4d4d4d] flex">
                    {numeral(item.price).format("$0,0")}
                  </span>
                  <span className="text-[#202124] flex-grow capitalize ">
